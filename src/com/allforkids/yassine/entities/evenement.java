...
public int nbr_place ;
    ...
    public evenement( int evenement_user, String nom, String description, Date date_debut, Date date_fin, String emplacement, String image, int etat, int nbr_place) {
