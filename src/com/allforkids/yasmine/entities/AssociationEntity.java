 ...
 */
package com.allforkids.yasmine.entities;
...
public float lng;
    ...
    public AssociationEntity(int id_aasociation, int association_user, String nom, String description, int num_tel, String gouvernorat, String municipalite, String nomrue, String coderue, float lat, float lng) {
        ...
        public AssociationEntity(int id_aasociation, int association_user, String nom, String description, int num_tel, String gouvernorat) {
        this.id_aasociation = id_aasociation;
        this.association_user = association_user;
        this.nom = nom;
        this.description = description;
